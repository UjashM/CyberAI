...
request.onload = function(){
    ...
    {
        let imageElement =  '<div class = "col-xl-2 col-lg-3"><img class = "agency-logo" src = "'+ grant[i].image +'" /></div>';
        content = content + '<div class = "display-flex opportunity-container search-container">'+ imageElement + '<div class = "col-xl-10 col-lg-9"><h4 class = "opp-header black-content-header-no-margin">'+ grant[i].title +'</h4>'+
